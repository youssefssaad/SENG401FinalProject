    ...
    <div className="modal">
      <div className="modal-content">
        ...
        <p className="expenses-instruction">
          ...
          the category and the quantity you hope to spend per month in that
          category. You can also add more fields by clicking the 'ADD' button.
          You can remove a category by clicking the '-' button on the right of
          each button. After all the categories are added, you can click the
          'SAVE' button to save your goals and exit out of the modal.
        </p>
        <p className="expenses-instruction">
          Outside, the modal, you can see the total budget and the expenses you
          have set based on the respective categories. Here, you can add your
          total monthly income, and below it, add how much you spent so far in
          the month for that category. If the spent money is coloured green, you
          have still met your financial goal. If the spent money is coloured
          red, you have spent more than your goal in that category. If you hover
          on top of the red categories, they will display the amount you have
          overspent.
        </p>
      </div>
    </div>
